...
payload_mesh = 'package://RotorTM/mesh/triangular_payload.STL'; %TODO move this to pl_params
if nquad == 1
    ...
    payload_marker_msg = init_marker_msg(pl_odom_pub,2,0,worldframe,payload_marker_scale,payload_marker_color, payload_mesh);
else
