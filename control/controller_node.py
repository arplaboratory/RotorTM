...
from utils.math.QuatToRot import QuatToRot
from utils.math.vec2asym import vec2asym
from utils.math.RotToRPY_ZXY import RotToRPY_ZXY
...
class controller_node:
    ...
    def __init__(self):
        ...
        # init subscribers
        rospy.Subscriber('/des_traj', PositionCommand, self.desired_traj_callback)
    ...
    def desired_traj_callback(self, des_traj):
        ...
        self.pl["jrk_des"] = np.array([ [des_traj.jerk.x],
                                        [des_traj.jerk.y],
                                        [des_traj.jerk.z]])                     
        self.pl["yaw_des"] = des_traj.yaw
        self.pl["yawdot_des"] = des_traj.yaw_dot
        self.sim_subscriber()
