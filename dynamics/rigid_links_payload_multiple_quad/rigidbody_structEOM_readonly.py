...
def rigidbody_structEOM_readonly(t = None,s = None,F = None,M = None,params = None): 
...
# Limit the force and moments due to actuator limits
    ...
    omgLdot = M - cross(s.omega,params.struct_I * s.omega)
    # Payload Acceleration
    accL = F / params.struct_mass - params.grav * np.array([[0],[0],[1]])
    # Assemble sdot
