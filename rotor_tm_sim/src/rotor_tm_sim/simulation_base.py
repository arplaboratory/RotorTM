...
from quadrotor_msgs.msg import ukf_measurement_update, FMCommand
...
class simulation_base():
  def __init__(self,pl_params,uav_params):
      ...
      for uav_id in range(self.nquad):
          ...
          self.robot_command_subscriber.append(rospy.Subscriber('/' + mav_name + '/rpm_cmd',RPMCommand,self.rpm_command_callback,uav_id,queue_size=1, tcp_nodelay=True))
      ...
      for idx in range(self.nquad):
        ...
        print(self.uav_params[idx].mesh_path)
      ...
      if self.hybrid_flag:
        ...
        while not rospy.is_shutdown():
            ...
            for uav_id in range(self.nquad-1, -1, -1):
                ...
                imu_pub.orientation.w = uav_quat_with_noise[3]
                imu_pub.orientation.x = uav_quat_with_noise[0]
                imu_pub.orientation.y = uav_quat_with_noise[1]
                imu_pub.orientation.z = uav_quat_with_noise[2]
